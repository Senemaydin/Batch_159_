...
public class Variables01 {
    ...
    //char data type: char is for a single character. For example :  A, ?, 5 etc.
    //                When you use a value for ''char''s, put it between single quotes
    //                 char uses 16 bits(2 bytes) in memory
    public char initial = 'A';

    //byte data type: byte is whole numbers. Like 23, 345, 8, -98 etc.
    ...
    public short numOfPeopleApartment = 2500;

    //int data type: int is for whole numbers. Like 43, 23987, 2300000, 1000000,
    ...
    //               long can have values from -9,223,372, 036, 854, 755,888 to 9, 223,372, 036, 854, 755,887
    ...
    public long  profit = 2300000;

    //float data type: float is for decimal values. Like 2.43 , 5.234, etc.
    //                 float uses 32 bits in memory
    public float priceOfShirt = 12.99F;

    //double data type: double is for decimal values. Like 3.2456897
    //                double uses 64 bits in memory
    public double weightOfACell = 0.00000000234;
