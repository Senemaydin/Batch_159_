...
public class Variables03 {
    ...
    public static void main(String[] args) {
        ...
        //Note: If you use different data types mathematical operation, the result will be in the largest data type.

        //Note: If you use same data type in a mathematical operation result will in the data type
        //When you divide an int by another int, the result can be double like in 6/5=1.2 but Java makes the data type
        //  result in int as well.
        ...
        System.out.println(1.2/1.2);//1.0

        //Example 1: Estimate the result of the given operation
        //           (2+4.6) / 3 - 4 * 2
        System.out.println((2+4.6F) / 3 - 4 * 2);//-5.8
