...
public class StringManipulations02 {
    ...
    public static void main(String[] args) {
       ...
       boolean firstRule = pwd.length()>7;
        System.out.println(firstRule);//true
        ...
        //4)Password must have at least a lowercase character
        boolean fourtRule = pwd.replaceAll("[^a-z]","").length()>0;
        System.out.println(fourtRule);//true
        ...
        System.out.println(firstRule && secondRule && thirdRule && fourtRule && fifthRule && sixthRule );
