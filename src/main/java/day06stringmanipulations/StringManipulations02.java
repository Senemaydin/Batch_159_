...
public class StringManipulations02 {
    ...
    5)equalsIgnoreCase() method is for checking if two Strings are exactly same or not by ignoring cases.
    ...
    public static void main(String[] args) {
       ...
       //Example 2: Type code to check if first and last character are some in a String
        ...
        System.out.println(firstChar.equalsIgnoreCase(lastChar));
        System.out.println(firstChar.equals(lastChar));
        System.out.println("Are first and last character same? " + firstChar.equalsIgnoreCase(lastChar));
        ...
        //Example 4: Type code to check if a String is empty ork has just space character or not
        //         ""==>true  - " " ==> true -         "    " ==> true
        String st = "    ";
