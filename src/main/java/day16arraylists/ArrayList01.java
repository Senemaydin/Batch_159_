...
public class ArrayList01 {
    /*
           ...
           3) If Arrays are not good why did not Java, and Arrays from Java structure?
    ...
    public static void main(String[] args) {
        ...
        //1.Way:
        //Get the number of elements in the list, if it is zero it means the list empty
        ...
        System.out.println(countries); //[UK, USA, TR]
...
//        }
        ...
        //If you want to make it Integer element, use auto boxing lik (Integer)23
        ages.remove((Integer)23);
        System.out.println(ages);

        //Example 4: Create an Integer ArrayList and remove a multiple element
