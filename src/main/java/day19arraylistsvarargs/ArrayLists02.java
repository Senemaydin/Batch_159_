...
public class ArrayLists02 {
    public static void main(String[] args) {
        ...
        //          If the number user entered exist in the Database change the number to "Bingo"
        //           If the number user entered does not exist in the Database add it into the DB
