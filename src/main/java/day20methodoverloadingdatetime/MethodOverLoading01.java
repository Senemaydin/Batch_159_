...
public class MethodOverLoading01 {
    ...
    /*
     ...
     2)To make the parameters different i)Change the data type of th parameters
                                       ii)Change the number of the parameters
                                       iii)Change the order of  the parameters if the data type of the parameters are different.
      ...
      4)"private methods" can be overloaded as well, because "Method Overloading" is done in a single class, if you are not going
    ...
    //Create a method multiplies an integer by a double
    private static double multiply(int a, double b){
        return a*b;
    }

    //Create a method multiplies a double by an integer
