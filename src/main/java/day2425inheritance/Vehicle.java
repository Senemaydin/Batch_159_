...
public class Vehicle {
    ...
    5)To be able to execute constructors from top to bottom
    Java goes to Object Class first by the help of "super()"
    ...
    11)When you type "this()", you have to type it in first line of constructor body
    12)"this()" and "super()" can not be used in the same constructor  together, because
    if you put anyone of them in the first line other one can not be put in the first line.
     */
    ...
    public Vehicle(String name){
         this();//It takes me to the constructor with
