...
public class Sets01 {
    ...
    /*
        ...
        There are 3 sets i)HashSet:
                           "Hash"ing is a technique to create unique codes for data
                            HashSet does not put the elements in any order. HashSet puts the element in random order.
                            HashSet is so fast because it does not spend time to order the elements.
                            HashSet is superfast
    ...
    public static void main(String[] args) {
        ...
        //Removes from the first collection all of its elements that are not contained in the specified collection.
        lhs.retainAll(mhs);
        ...
        System.out.println(hs); //[null, USA, Turkey, Belgium, UK, Germany, Albania]
        ...
        /*
        If you need to store "unique elements" in "natural order" do not user TreeSet to add elements because it is so slow.
        ...
        hs2.add("USA");
        hs2.add("UK");
        hs2.add("Albania"); //When you add a data repeatedly Java does not give error, but it accepts it just once
        hs2.add("Turkey");
        ...
        System.out.println(t2-t1); // 456431 nano
        System.out.println(t3-t2); // 2823927 nano
        System.out.println(t4-t3); // 155334 nano
