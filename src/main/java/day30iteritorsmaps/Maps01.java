...
public class Maps01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(values);  //[400, 85, 87, 3]
        ...
        int populationAlbania = cp.get("Albania"); //get() gives you the value of a specific key
        System.out.println(populationAlbania); //3
