...
public class HashTable01 {
    ...
    2)HashTable puts the elements in random over.
    ...
    public static void main(String[] args) {
       ...
       // System.out.println(ht.get("Ali Can") + ht.get("Tom Hanks") + ht.get("Brad Pitt") + ht.get("Angelina Jolie")); //Run time error
        System.out.println(ht.getOrDefault("Ali Can",0) + ht.getOrDefault("Tom Hanks", 0) + ht.getOrDefault("Brad Pitt",0) + ht.getOrDefault("Angelina Jolie",0)); //134
