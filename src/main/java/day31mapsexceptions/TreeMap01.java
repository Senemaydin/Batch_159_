...
public class TreeMap01 {
    ...
    4)TreeMap does not except null in "key"s but accepts "null" in "value"s
    ...
    public static void main(String[] args) {
        ...
        tm.put("Cuney Arkin", 78);

        System.out.println(tm);   //{Ajda Pekkan=76, Ali Can=13, Brad Pitt=56, Cuney Arkin=78, Tom Hanks=65}
        ...
        System.out.println(hm); //{Tom Hanks=65, Brad Pitt=56, Ajda Pekkan=76, Ali Can=13, Cuneyt Arkin=78}
        ...
        System.out.println(t2-t1); //2714630
        System.out.println(t3-t2); //247356
        System.out.println(t4-t3); //68803
