...
public class Lambda01 {
    public static void main(String[] args) {
       ...
       names.add("Chris");
        ...
        printIntegers1(3,11); //3 4 5 6 7 8 9 10 11
        System.out.println();
        printIntegers2(3,11); //3 4 5 6 7 8 9 10 11
        System.out.println();
        ...
        System.out.println();
        System.out.println(getFactorial(-5)); //Factorial of negative integers cannot be calculated  -1

        System.out.println();
        System.out.println(findTheSumOfIntBetweenTwoGivenIntegers(4, 7)); //22
        System.out.println();
        System.out.println(findTheSumOfIntBetweenTwoGivenIntegers(7, 4)); //22
        System.out.println();

        System.out.println(getTheSumOfDigitsOfIntegersGivenRange1(45, 47)); //30
        System.out.println(getTheSumOfDigitsOfIntegersGivenRange2(45, 47)); //30
    ...
    public static List<Integer> getSquaresOfLengthsInListDistinctly1(List<String> names){
       ...
       return names.
                   ...
                   map(String::length). //map(t->t.length()) can be used as well
                    ...
                    distinct().
                    map(Utils::getSquare). //map(t->t.length()) can be used as well
    ...
    //Example 2: Create a method print the integers from 3 to 11
    ...
    public static void printIntegers2(int start, int end){
        ...
        IntStream.
                ...
                forEach(Utils::printInTheSameLineWithSpace); //t-> System.out.print(t + " ") can be used as well
    }

    //Example 3: Create a method to calculate the factorial of given number
    //         5! ==> 1*2*3*4*5 = 120    3! ==> 3*2*1 = 6  0! = 1         No factorial negative integers
    ...
    public static int findTheSumOfIntBetweenTwoGivenIntegers(int start, int end){
    ...
    //1.Way:
    public static int getTheSumOfDigitsOfIntegersGivenRange1(int a, int b){
     return    IntStream.rangeClosed(a, b).map(Utils::getSumOfDigits).reduce(Math::addExact).getAsInt();


    }
   //2.Way:
    public static int getTheSumOfDigitsOfIntegersGivenRange2(int a, int b){
