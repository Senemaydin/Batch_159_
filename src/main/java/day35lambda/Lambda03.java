...
public class Lambda03 {
     ...
     */
        ...
        public static void main(String[] args) {
            ...
            printSquareOfUniqueOddElements(nums);
            System.out.println();
            ...
            System.out.println();
            System.out.println(isNonNegative(nums));
            System.out.println();
        ...
        public static void printSquareOfUniqueOddElements(List<Integer> myList){
            myList.
                    stream().
                    distinct().
        ...
        //Example 3: Create a method to find the sum of the cube of different even elements in a list
        public static int findSumOfCubeOfDistinctEvens(List<Integer> myList){
            return myList.
                    stream().
                    distinct().
                    filter(Utils::checkToBeEven).
                    map(t-> t*t*t).//We use cube calculation just a couple time that is why I did not create a method it in Utils Class
        ...
        public static int findMultiplication(List<Integer> myList){
            return   myList.
                    stream().
                    filter(t->t<15). //filter(t-> t<15 && t%2==0)
                    filter(Utils::checkToBeEven).
        ...
        public static boolean isNonNegative(List<Integer> myList){
